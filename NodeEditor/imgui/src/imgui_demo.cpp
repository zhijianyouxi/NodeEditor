...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Sorting"))
    {
        ...
        ImGui::SameLine(); HelpMarker("When sorting is enabled: hold shift when clicking headers to sortLaserOffset on multiple column. TableGetSortSpecs() may return specs where (SpecsCount > 1).");
