...
#include <Nodes/utils/source_location.h>
//#include <zeno/utils/cformat.h>
// #include <Nodes/utils/format.h>
#include <string_view>
...
NODE_API void set_log_level(log_level_t level);
NODE_API void set_log_stream(std::ostream &osin);
NODE_API bool __check_log_level(log_level_t level);
NODE_API void __impl_log_print(log_level_t level, source_location const &loc, std::string_view msg);
