...
template <size_t N, class T>
struct tuple_size<::NodeEditor::vec<N, T>> : integral_constant<size_t, N> {
};

template <size_t I, size_t N, class T>
struct tuple_element<I, ::NodeEditor::vec<N, T>> {
    using type = enable_if_t<(I < N), T>;
};

template <size_t I, size_t N, class T>
T const &get(::NodeEditor::vec<N, T> const &t) {
    return t[I];
}

template <size_t I, size_t N, class T>
T &get(::NodeEditor::vec<N, T> &t) {
    return t[I];
}
